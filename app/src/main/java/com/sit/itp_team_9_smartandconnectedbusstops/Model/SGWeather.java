        ...
        AsyncTask task = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
                if(weatherParser == null) {
                    ...
                    setmWeatherForecast(MainActivity.context.getResources().getString(R.string.refreshingdata));
                    getForecast();
                    return null;
                }
                ...
                for(Forecasts entry : forecasts){
                    if(entry.getArea().equals(meta[0].getName())) {
                        ...
                        if(entry.getForecast().contains("Fair")) {
                            ...
                            translatedForecast = dayNightForecast.replace("Cloudy", MainActivity.context.getResources().getString(R.string.cloudy));
                        }
                        else if(entry.getForecast().contains("Light Showers")) {
                            translatedForecast = dayNightForecast.replace("Cloudy", MainActivity.context.getResources().getString(R.string.lightshowers));
                        }
                        else if(entry.getForecast().contains("Showers")) {
                            translatedForecast = dayNightForecast.replace("Partly Cloudy", MainActivity.context.getResources().getString(R.string.showers));
                        }
                        else if(entry.getForecast().contains("Thundery Showers")) {
                            translatedForecast = dayNightForecast.replace("Partly Cloudy", MainActivity.context.getResources().getString(R.string.thunderyshowers));
                        }
        ...
        AsyncTask task = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
                if(weatherParser == null) {
                    ...
                    setmWeatherForLatLong(MainActivity.context.getResources().getString(R.string.refreshingdata));
                    getForecast();
                    return null;
                }
